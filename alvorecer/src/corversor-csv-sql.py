...
arquivo_csv = str(diretorio_atual)[:-3] + "dados/dadosSensores_grafico.csv"
dados = [] 
...
arquivo_nome = "meu_arquivo.sql"
diretorio_saida = os.path.join(os.path.expanduser("~"), str(diretorio_atual)[:-3]+"sql")
